...
This R package generates high-resolution estimates of tree-specific bioclimate variables for landscapes across North America. It calculates bioclimate based on the fitted model described in ["A tree's view of the terrain" (Kling, Baer, and Ackerly, 2024, Ecography)](https://doi.org/10.1111/ecog.07131), which uses tree species distributions as climate indicators. The outputs are estimates of fine-scale climate patterns as experienced by trees, and may not correspond to microclimate measured using standard approaches. 
